...
const ListSightings = () => {
    ...
    return (
        ...
        <MyForm key={editingSighting ? editingSighting.sighting_id : null} onSaveSighting={onSaveSighting} editingSighting={editingSighting} onUpdateSighting={updateSighting} />
        </div>
    );
}
